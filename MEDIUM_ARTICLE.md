...
## Step 2b: Configure Authorization Scopes

Still in the app settings, go to **User authorization** and add these four scopes:
...
Click **"+ Add scope"** for each one. Users will consent to these permissions the first time they open the app.

> **This step is critical.** Without these scopes, the health check will fail with SQL permission errors.
